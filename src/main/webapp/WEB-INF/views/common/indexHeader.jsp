...
<header>
    <nav>
        <div class="nav-container" style="height: 100px; padding-top: 30px;">
            <a href="#"><img class="main-logo" src="/resources/img/headerLogo.png" ></a>
            <ul class="signup-login">
                <li><a class="main-button" href="#">회원가입</a></li>
                <li><a class="main-button" href="#">로그인</a></li>
            </ul>
        </div>
        <div class="nav-container" style="height: 40px;">
            ...
            <div id="my-menu">
                ...
                <a href="#"><i class="fa-solid fa-cart-shopping fa-xl" style="color: #375890; margin-right: 10px;"></i></a>
